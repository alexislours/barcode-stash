...
#
# Before:  screenshots/en-US/Screenshot-en-US-01-History.png
# After:   screenshots_organized/01-History/01-en-US.png
#
# Before:  screenshots_ipad/en-US/Screenshot-iPad-en-US-01-History.png
# After:   screenshots_ipad_organized/01-History/01-en-US.png
...
organize() {
    ...
    for i in "${!LANGUAGES[@]}"; do
        ...
        for file in "$lang_dir"/*.png; do
            ...
            # Screenshot-en-US-01-History.png      -> 01-History
            # Screenshot-iPad-en-US-01-History.png  -> 01-History
            local screen_name
